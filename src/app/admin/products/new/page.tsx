...
export default function NewProductPage() {
  ...
  const handlePublish = async () => {
    ...
    try {
      ...
      const payload: any = {
        ...
        discountPrice: mrp ? Number(mrp) : undefined,
        discountPercent: cost ? Number(cost) : undefined,
  ...
  const [cost, setCost] = useState(''); // Will be renamed below
  ...
  const [isSubmitting, setIsSubmitting] = useState(false);
    const [status, setStatus] = useState<boolean>(true); // true = publish, false = unpublish
        ...
        <CardContent className="space-y-8">
          ...
          <div className="space-y-4">
            ...
            <div className="grid gap-4 sm:grid-cols-4">
              <div className="grid gap-2">
                ...
                <Input id="productCode" placeholder="Enter product code" value={productCode} onChange={e => setProductCode(e.target.value)} />
              </div>
              <div className="grid gap-2">
          ...
          <div className="space-y-4">
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              ...
              <div className="grid gap-2">
                ...
                <Input id="discountPrice" type="number" placeholder="0" value={mrp} onChange={e => setMrp(e.target.value)} />
              </div>
              <div className="grid gap-2">
                <Label htmlFor="discountPercent">Discount Percent (%)</Label>
                <Input id="discountPercent" type="number" placeholder="0" value={cost} onChange={e => setCost(e.target.value)} />
              </div>
            </div>
            {/* EMI Radio Button */}
          ...
          <div className="space-y-4">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="grid gap-2">
                ...
                <Input id="lowStock" type="number" placeholder="10" value={lowStock} onChange={e => setLowStock(e.target.value)} />
              </div>
            </div>
            ...
            <div className="flex items-center gap-2">
              <Switch id="allowBackorder" checked={allowBackorder} onCheckedChange={setAllowBackorder} />
          ...
          <div className="space-y-4">
            ...
            <div className="grid gap-2">
              ...
              <Input id="metaTitle" placeholder="Enter meta title" value={metaTitle} onChange={e => setMetaTitle(e.target.value)} />
            ...
            <div className="grid gap-2">
              ...
              <Input
                ...
                onChange={e => setMetaKeywords(e.target.value.split(',').map(s => s.trim()).filter(Boolean))}
              />
            </div>
            <div className="grid gap-2">
            ...
            <div className="grid gap-2">
              ...
              <Input
                ...
                onChange={e => setSeoKeywords(e.target.value.split(',').map(s => s.trim()).filter(Boolean))}
              />
            </div>
            <div className="grid gap-2">
            ...
            <div className="grid gap-2">
              ...
              <Input
                ...
                onChange={e => setHighlights(e.target.value.split(',').map(s => s.trim()).filter(Boolean))}
              />
            </div>
            <div className="grid gap-2">
